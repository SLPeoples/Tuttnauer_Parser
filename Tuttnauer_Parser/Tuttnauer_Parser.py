...
def parse_input(input,output, verbose):
    ...
    d = {'cycleNum': cycleNum, 'cycleName' : cycleName, 'cycleDate': cycleDate,'startTime':startTime,'endTime':endTime,
    ...
    df.to_csv(output+"tuttnauer_combined.csv", index=False)
